...
/* harmony import */ var _modules_YoutubeVideoPlayer__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/YoutubeVideoPlayer */ "./src/js/modules/YoutubeVideoPlayer.js");
/* harmony import */ var _modules_YoutubeVideoPlayer__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_modules_YoutubeVideoPlayer__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _modules_TestimonialsSlider__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/TestimonialsSlider */ "./src/js/modules/TestimonialsSlider.js");
/* harmony import */ var _modules_FeedbackForm__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/FeedbackForm */ "./src/js/modules/FeedbackForm.js");
/* harmony import */ var _modules_SendFeedback__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/SendFeedback */ "./src/js/modules/SendFeedback.js");




var feedbackForm = new _modules_FeedbackForm__WEBPACK_IMPORTED_MODULE_2__["default"]('#feedback-form');
feedbackForm.init();
var sendFeedback = new _modules_SendFeedback__WEBPACK_IMPORTED_MODULE_3__["default"]({
...
var FeedbackForm = /*#__PURE__*/function () {
  function FeedbackForm(cssSelector) {
  ...
  _createClass(FeedbackForm, [{
    ...
    value: function addEventListener() {
      ...
      this.domElementsCausingForm.forEach(function (domElement) {
        domElement.addEventListener('click', _this.open.bind(_this));
      });
    ...
    key: "isCorrectlyEnteredData",
    value: function isCorrectlyEnteredData() {
...
/***/ "./src/js/modules/SendFeedback.js":
/*!****************************************!*\
  !*** ./src/js/modules/SendFeedback.js ***!
  \****************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (SendFeedback);

/***/ }),

/***/ "./src/js/modules/TestimonialsSlider.js":
/*!**********************************************!*\
  !*** ./src/js/modules/TestimonialsSlider.js ***!
  \**********************************************/
/*! no exports provided */
...
var reviewTextWrapper = document.querySelector('.testimonials__item-reviewer-text');
var reviewTextButton = document.querySelector('.testimonials__toggle-text');
reviewTextButton.addEventListener('click', function () {
...
var nextSlideButton = document.querySelector('.testimonials__pagination-right');
var prevSlideButton = document.querySelector('.testimonials__pagination-left');
var slides = document.querySelectorAll('.testimonials__item');
var slidesWrapper = document.querySelector('.testimonials__list');
var dots = document.querySelectorAll('.testimonials__pagination-dot');

var moveSlides = function moveSlides() {
  var slideWidth = slidesWrapper.offsetWidth;
  slides.forEach(function (slide, index) {
    if (slide.dataset.slideActive === 'true') {
      var activeSlideIndex = index;
      var slideMove = slideWidth * activeSlideIndex;
      slidesWrapper.style.transform = "translateX(-".concat(slideMove, "px)");
    }
  });
};
...
var onClickNextSlideButton = function onClickNextSlideButton() {
  var isSkipIteration = false;
  slides.forEach(function (slide, index) {
    if (isSkipIteration) {
      return;
    }
...
var onClickPrevSlideButton = function onClickPrevSlideButton() {
  var isSkipIteration = false;
  slides.forEach(function (slide, index) {
    if (isSkipIteration) {
      return;
...
/***/ "./src/js/modules/YoutubeVideoPlayer.js":
/*!**********************************************!*\
  !*** ./src/js/modules/YoutubeVideoPlayer.js ***!
  \**********************************************/
/*! no static exports found */
...
var onLoadWindow = function onLoadWindow() {
  var playButton = document.querySelector('.video-player__play-button');
  var videoPlayer = document.querySelector('.video-player-wrapper');
  var player = null;
